                                        ...
                                        <div>
                                            ...
                                            <div className="mt-2 space-y-1">
                                                {drives.filter(d => d.is_removable).map(drive => (
                                                    <SidebarItem key={drive.mount_point} node={drive} />
                                                ))}
                                            </div>
                                        </div>
                                    )}
                                        ...
                                        <div>
                                            ...
                                            <div className="mt-2 space-y-1">
                                                {systemNodes.map(node => (
                                                    <SidebarItem key={node.mount_point} node={node} />
                                                ))}
                                            </div>
                                        </div>
                                    )}
            ...
            <SidebarFooter className="p-4 border-t border-border/40">
                <div className="space-y-4">
                    ...
                    <Button
                        ...
                        className="w-full justify-between h-8 px-2 text-muted-foreground hover:text-foreground hover:bg-muted/50 group"
                    >
                        <div className="flex items-center gap-2">
                            <div className={cn("transition-transform duration-200", isSettingsOpen && "rotate-90")}>
                                <ChevronRight className="w-3.5 h-3.5" />
                            </div>
                            <span className="text-[10px] font-black uppercase tracking-widest">Scan Configuration</span>
                        </div>
                    </Button>
